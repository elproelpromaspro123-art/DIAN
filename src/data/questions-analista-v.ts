...
const FASE_1_TEXT =
  "Base oficial: Manual de funciones Analista V (OPEC 236732 y 236756), Acuerdo 21 de 2025 DIAN 2676, Estatuto Tributario. Puntaje mínimo aprobatorio: 70/100.";
...
const analistaExtraQuestions: Question[] = [
  ...
  // ── 6. Peso Fase 1 (Acuerdo 21 de 2025) ─────────────────────────
  {
    id: 0,
    groupLabel: FASE_1_LABEL,
    groupText: FASE_1_TEXT,
    text: "Según el Acuerdo 21 de 2025 DIAN 2676, ¿cuál es el peso de la Fase 1 (Competencias Funcionales) para el Analista V?",
    options: [
      { letter: "A", text: "70%" },
      { letter: "B", text: "60%" },
      { letter: "C", text: "65%" },
  ...
  // ── 7. Carácter eliminatorio ──────────────────────────────────────
  {
    ...
    groupLabel: FASE_1_LABEL,
    groupText: FASE_1_TEXT,
    text: "En el Acuerdo 21 de 2025, la Fase 1 del Analista V tiene carácter:",
    options: [
  ...
  // ── 8. Puntaje mínimo aprobatorio ─────────────────────────────────
  {
    ...
    correctAnswer: "D",
    explanation:
      "El Acuerdo 21 de 2025 fija un mínimo aprobatorio de 70/100 en la prueba eliminatoria de competencias funcionales.",
  },
  // ── 9. Peso Fase 2 ────────────────────────────────────────────────
  {
    id: 0,
    ...
    text: "Según el Acuerdo 21 de 2025, el peso de la Fase 2 (Competencias Comportamentales) para el Analista V es:",
    options: [
      { letter: "A", text: "15%" },
      { letter: "B", text: "20%" },
      { letter: "C", text: "10%" },
  ...
  // ── 10. Peso Fase 3 ───────────────────────────────────────────────
  {
    ...
    text: "El peso de la Fase 3 (Prueba de Integridad) para el Analista V según el Acuerdo 21 de 2025 es:",
    options: [
      { letter: "A", text: "20%" },
      { letter: "B", text: "5%" },
      { letter: "C", text: "10%" },
    ...
    correctAnswer: "C",
    explanation:
      "La Prueba de Integridad tiene peso de 10% y carácter clasificatorio según la Tabla 7 del Acuerdo 21 de 2025.",
  },
