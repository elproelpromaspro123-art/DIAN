...
const FASE_1_TEXT =
  "Base oficial: Manual de funciones Gestor I (OPEC 236741 y 236767), Acuerdo 21 de 2025 DIAN 2676, Ley 80/1993, Ley 1150/2007. Puntaje mínimo aprobatorio: 70/100.";
...
const gestorExtraQuestions: Question[] = [
  ...
  // ── 6. Peso Fase 1 (Acuerdo 21 de 2025) ─────────────────────────
  {
    ...
    groupLabel: FASE_1_LABEL,
    groupText: FASE_1_TEXT,
    text: "Según el Acuerdo 21 de 2025 DIAN 2676, ¿cuál es el peso de la Fase 1 (Competencias Funcionales) para el Gestor I?",
    options: [
      { letter: "A", text: "65%" },
      { letter: "B", text: "70%" },
      { letter: "C", text: "60%" },
  ...
  // ── 7. Carácter eliminatorio ──────────────────────────────────────
  {
    ...
    groupLabel: FASE_1_LABEL,
    groupText: FASE_1_TEXT,
    text: "En el Acuerdo 21 de 2025, la Fase 1 del Gestor I tiene carácter:",
    options: [
  ...
  // ── 9. Peso Fase 2 ────────────────────────────────────────────────
  {
    ...
    text: "Según el Acuerdo 21 de 2025, el peso de la Fase 2 (Competencias Comportamentales) para el Gestor I es:",
    options: [
      { letter: "A", text: "15%" },
      { letter: "B", text: "20%" },
      { letter: "C", text: "25%" },
  ...
  // ── 10. Peso Fase 3 ───────────────────────────────────────────────
  {
    ...
    text: "El peso de la Fase 3 (Prueba de Integridad) para el Gestor I según el Acuerdo 21 de 2025 es:",
    options: [
      { letter: "A", text: "10%" },
      { letter: "B", text: "5%" },
      { letter: "C", text: "15%" },
    ...
    correctAnswer: "A",
    explanation:
      "La Prueba de Integridad tiene peso de 10% y carácter clasificatorio según la Tabla 8 del Acuerdo 21 de 2025.",
  },
