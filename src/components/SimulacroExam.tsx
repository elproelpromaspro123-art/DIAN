...
function getScoreColor(score: number): string {
  ...
  if (score >= 60) return "text-dian-navy";
  if (score >= 40) return "text-dian-gold";
  return "text-dian-danger";
}
...
export default function SimulacroExam({
  ...
  useEffect(() => {
    if (typeof window === "undefined") return;
    localStorage.setItem("dian_reading_mode", String(readingMode));
  }, [readingMode]);
    ...
    return (
      <div className={`min-h-screen ${rootClass}`}>
        <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          >
            <Trophy className="w-16 h-16 mx-auto mb-4 text-dian-gold" />
            <h1 className="text-2xl font-bold text-dian-navy mb-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
              ...
              <div className="bg-blue-50 rounded-xl p-4">
                <div className="flex items-center justify-center gap-1">
                  <Clock className="w-4 h-4 text-dian-navy" />
                  <p className="text-xl font-bold text-dian-navy">
                    {formatTime(elapsed)}
                  </p>
                </div>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link
                href={areaHref}
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-dian-navy text-white rounded-xl font-medium hover:bg-dian-navy-light transition-colors text-sm"
              >
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-gray-500">
              <button
                ...
                className={`rounded-full border px-3 py-1 font-semibold transition-colors ${
                  showOnlyIncorrect
                    ? "border-dian-navy bg-dian-mint text-dian-navy"
                ...
                >
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {q.groupLabel && (
                        <div className="bg-dian-mint border border-dian-navy/20 rounded-lg p-3 mb-3">
                      ...
                      <div className="bg-dian-mint rounded-lg p-4">
  ...
  return (
    <div className={`min-h-screen ${rootClass} flex flex-col`}>
      ...
      <div className="bg-white border-b shadow-sm sticky top-0 z-40 exam-surface">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:flex items-center gap-1.5 text-sm text-dian-navy font-medium">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="px-4 py-1.5 bg-dian-danger text-white text-xs font-semibold rounded-lg hover:bg-red-700 transition-colors"
            >
              Finalizar
            </button>
          </div>
        ...
        <div className="h-1 bg-gray-100">
          <div
            className="h-full bg-dian-navy transition-all duration-300"
            style={{
      ...
      <div className="sm:hidden fixed bottom-24 right-3 z-40 pointer-events-none">
        <div className="bg-dian-navy text-white text-[11px] px-3 py-2 rounded-full shadow-lg">
      ...
      <AnimatePresence>
        {showConfirm && (
          ...
          >
            ...
            >
              <AlertCircle className="w-12 h-12 mx-auto mb-3 text-dian-gold" />
              ...
              {answeredCount < questions.length && (
                <p className="text-xs text-dian-danger mb-4">
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl bg-dian-danger text-white font-semibold hover:bg-red-700 text-sm"
                >
                  Finalizar
                </button>
              </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {currentQ.groupLabel && showSharedImage && (
              <div className="bg-dian-mint border-2 border-dian-navy/20 rounded-xl p-4 mb-4">
                <p className="text-sm sm:text-base md:text-lg font-semibold text-dian-navy uppercase tracking-wide mb-3">
                  {currentQ.groupLabel}
                </p>
                {currentQ.groupText && (
            ...
            {currentQ.groupLabel && !showSharedImage && currentQ.sharedImage && (
              <details className="bg-dian-mint border-2 border-dian-navy/20 rounded-xl p-4 mb-4">
              <summary className="text-sm sm:text-base md:text-lg font-semibold text-dian-navy uppercase tracking-wide cursor-pointer">
            ...
            {questions.map((q, i) => (
              <button
                ...
                className={`w-7 h-7 sm:w-7 sm:h-7 rounded-md text-xs font-medium transition-colors shrink-0 ${
                  i === currentIndex
                    ? "bg-dian-navy text-white"
                    : answers[q.id]
                    ? "bg-dian-mint text-dian-navy"
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium transition-colors ${
              currentIndex === questions.length - 1
                ? "bg-dian-danger text-white hover:bg-red-700"
                : "text-dian-navy hover:bg-dian-mint"
            }`}
          >
